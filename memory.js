document.addEventListener("DOMContentLoaded", () => {
  ...
  const themes = {
    smeshariki: {
      ...
      chars: [
        { 
          name: "Крош", 
          img: "https://static.wikia.nocookie.net/smeshariki/images/8/8f/Krosh.png" 
        },
        { 
          name: "Ёжик", 
          img: "https://static.wikia.nocookie.net/smeshariki/images/2/20/Yozhik.png" 
        },
        { 
          name: "Нюша", 
          img: "https://static.wikia.nocookie.net/smeshariki/images/8/85/Nyusha.png" 
        },
        { 
          name: "Бараш", 
          img: "https://static.wikia.nocookie.net/smeshariki/images/3/39/Barash.png" 
        },
        { 
          name: "Лосяш", 
          img: "https://static.wikia.nocookie.net/smeshariki/images/e/ed/Losyash.png" 
        },
        { 
          name: "Копатыч", 
          img: "https://static.wikia.nocookie.net/smeshariki/images/1/14/Kopatych.png" 
        },
        { 
          name: "Совунья", 
          img: "https://static.wikia.nocookie.net/smeshariki/images/6/64/Sovunya.png" 
        },
        { 
          name: "Пин", 
          img: "https://static.wikia.nocookie.net/smeshariki/images/2/23/Pin.png" 
        }
      ]
    },
    prostokvashino: {
  ...
  // Рубашка карточек (простая, без фото)
