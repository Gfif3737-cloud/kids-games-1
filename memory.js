        ...
        if (!firstCard) {
            ...
            if (board[firstCard].name === card.name) {
                ...
                setTimeout(() => {
                    ...
                    board[firstCard].element.style.backgroundColor = cardBackStyle.backgroundColor;
                    board[index].element.style.backgroundColor = cardBackStyle.backgroundColor;
                    board[firstCard].element.style.fontSize = '24px';
                    board[index].element.style.fontSize = '24px';
                    board[firstCard].element.textContent = cardBackStyle.text;
                    board[index].element.textContent = cardBackStyle.text;
