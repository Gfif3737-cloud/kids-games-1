document.addEventListener('DOMContentLoaded', () => {
    ...
    // Кнопки бонусов (уже есть в HTML)
    ...
    function activateBonus(type) {
        ...
        if (activeBonus === type) {
            activeBonus = null;
            bombBtn?.classList.remove('active-bonus');
            rocketBtn?.classList.remove('active-bonus');
            return;
        }
        ...
        // Подсвечиваем кнопку
        if (type === 'bomb') {
            bombBtn?.classList.add('active-bonus');
            rocketBtn?.classList.remove('active-bonus');
        } else {
            rocketBtn?.classList.add('active-bonus');
            bombBtn?.classList.remove('active-bonus');
        }
    }
    ...
    // Подключаем обработчики для кнопок бонусов
    if (bombBtn) {
        bombBtn.addEventListener('click', () => activateBonus('bomb'));
    }
    if (rocketBtn) {
        rocketBtn.addEventListener('click', () => activateBonus('rocket'));
    }
