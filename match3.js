    ...
    const levels = {
        ...
        level1: {
            ...
            lines: [
                ...
                { id: "arbatsko_pokrovskaya", name: "Арбатско-Покровская", color: "#1E3A8A", stations: [
        ...
        level2: {
            ...
            lines: [
                ...
                { id: "tagansko_krasnopresnenskaya", name: "Таганско-Краснопресненская", color: "#A020F0", stations: [
                ...
                { id: "kalinskaya", name: "Калининская", color: "#FFA500", stations: [
                    "Новогиреево", "Перово", "Шоссе Энтузиастов", "Авиамоторная", "Площадь Ильича",
                    "Марксистская", "Третьяковская"
                ]},
                { id: "solntsevskaya", name: "Солнцевская", color: "#FF8C00", stations: [
                ...
                { id: "serpukhovsko_timiryazevskaya", name: "Серпуховско-Тимирязевская", color: "#6B7280", stations: [
        ...
        level3: {
            name: "Новые линии",
            lines: [
                { id: "lublinsko_dmitrovskaya", name: "Люблинско-Дмитровская", color: "#14B8A6", stations: [
                ...
                { id: "bolshaya_koltsevaya", name: "Большая кольцевая", color: "#DB2777", stations: [
                ...
                { id: "butovskaya", name: "Бутовская", color: "#A5F3FC", stations: [
                ...
                { id: "troitskaya", name: "Троицкая", color: "#C084FC", stations: [
                ...
                { id: "mck", name: "МЦК", color: "#F87171", stations: [
        ...
        level4: {
            name: "МЦД",
            lines: [
                { id: "mcd1", name: "МЦД-1", color: "#FFB347", stations: [
                ...
                { id: "mcd2", name: "МЦД-2", color: "#F472B6", stations: [
                ...
                { id: "mcd3", name: "МЦД-3", color: "#60A5FA", stations: [
                ...
                { id: "mcd4", name: "МЦД-4", color: "#4ADE80", stations: [
