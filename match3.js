...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function dropCells(checkMatches = false) {
        // Сдвигаем вниз
        for (let col = 0; col < BOARD_WIDTH; col++) {
    ...
    function processMatchesAndScore() {
        ...
        // Падаем без проверки новых троек
        setTimeout(() => {
            dropCells(false);
        }, 100);
    }
    ...
    function activateBonusShuffle() {
        ...
        // После перемешивания не проверяем тройки
    }
