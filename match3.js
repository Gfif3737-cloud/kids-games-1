document.addEventListener("DOMContentLoaded", () => {
    ...
    const lineColors = {
        sokolnicheskaya: "#e74c3c",
        zamoskvoretskaya: "#2ecc71",
        arbatsko_pokrovskaya: "#3498db",
        filyovskaya: "#5dade2",
        koltsevaya: "#8e44ad"
    };
    ...
    function renderStationsList(line) {
        if (!collectedStations[line]) initCollectedStations(line);
    ...
    lineSelect.addEventListener("change", (e) => {
        ...
        if (!collectedStations[currentLine]) initCollectedStations(currentLine);
