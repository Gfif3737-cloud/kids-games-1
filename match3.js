document.addEventListener("DOMContentLoaded", () => {
    ...
    const levels = {
        ...
        // УРОВЕНЬ 3: Новые линии (5 линий) - МОНОРЕЛЬС ЗАМЕНЁН НА ТРОИЦКУЮ
        level3: {
            name: "Новые линии",
            lines: [
                ...
                { id: "troitskaya", name: "Троицкая", color: "#DA70D6", stations: [ // Заменили монорельс на Троицкую
        ...
        // УРОВЕНЬ 4: МЦД (4 линии) - ЦВЕТА ИСПРАВЛЕНЫ
        level4: {
            name: "МЦД",
            lines: [
                { id: "mcd1", name: "МЦД-1", color: "#e67e22", stations: [ // Оранжевый
                ...
                { id: "mcd2", name: "МЦД-2", color: "#FF69B4", stations: [ // Розовый (исправлено!)
                ...
                { id: "mcd3", name: "МЦД-3", color: "#4169E1", stations: [ // Королевский синий
                ...
                { id: "mcd4", name: "МЦД-4", color: "#32CD32", stations: [ // Ярко-зелёный (исправлено с фиолетового)
